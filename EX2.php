...
$employes = [
    ["nom" => "HAMZA", "poste" => "MANAGER", "salaire" => 4500],
    ["nom" => "ANAS", "poste" => "Designer", "salaire" => 4000],
    ["nom" => "NASSIMA", "poste" => "TECHNICIEN", "salaire" => 4800],
    ["nom" => "Sara", "poste" => "DEVELOPEUR", "salaire" => 6000],
    ["nom" => "MEHDI", "poste" => "Technicien", "salaire" => 3500]
];
...
<body>
    ...
    $utilisateurs = [
        ["email" => "HAMZA@example.com", "password" => "hello"],
        ["email" => "ANAS@example.com", "password" => "aaaaaaaaa"],
        ["email" => "NASSIMA@example.com", "password" => "hiiiii"],
        ["email" => "sara@example.com", "password" => "salut123"],
        ["email" => "MEHDI@example.com", "password" => "1234567"]
    ];
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($connexionReussie) {
            echo "<h2>Connexion réussie " . $email . ".</h2>";
        } else {
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["produits"])) {
        ...
        echo "<p>sélectionner au moins un produit.</p>";
    }
    ?>
</body>
</html>
...
if (!isset($_SESSION["utilisateurs"])) {
    $_SESSION["utilisateurs"] = [
        1 => ["nom" => "HAMZA", "email" => "HAMZA@example.com"],
        2 => ["nom" => "ISMAIL", "email" => "ISMAIL@example.com"],
        3 => ["nom" => "HIND", "email" => "HIND@example.com"]
    ];
}
